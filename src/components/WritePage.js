...
const WritePage = ({ onInsert }) => {
  ...
  const handleReturnPlaceChange = useCallback((newReturnPlace) => {
    setReturnPlace((args) => newReturnPlace);
  }, []);
